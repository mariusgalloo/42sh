...
static type_t check_type(char const *input, char const *ope[])
{
    type_t type = CMD;
...
static node_t *create_node(node_t *left, node_t *right,
    char **array, type_t type)
{
...
static char **arraytok(char **array, size_t start, size_t end)
{
    char **sub = NULL;
...
static node_t *parse_cmd(char **array, char const *ope[], size_t *idx)
{
    size_t start = *idx;
    char **sub = NULL;
...
static node_t *parse_pipe(char **array, char const *ope[], size_t *idx)
{
...
static node_t *parse_semi(char **array, char const *ope[], size_t *idx)
{
